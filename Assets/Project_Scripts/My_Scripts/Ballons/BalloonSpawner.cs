...
public class BalloonSpawner : MonoBehaviour
{
    ...
    public string[] brainFacts = {
        ...
        "[Нейрон] передаёт сигнал со скоростью 431 км/ч",
        "[Факт] В мозге около 86 миллиардов нейронов",
        "[Сон] Во сне мозг очищается от токсинов",
        "[Музыка] активирует больше зон мозга, чем любой другой стимул",
        "[Развитие] Мозг продолжает развиваться до 25 лет",
        "[Ночь] Мозг активнее ночью, чем днём",
        "[Боль] Мозг чувствует социальную боль так же, как физическую",
        "[Память] Мозг способен хранить около 2.5 петабайт информации",
        "[Скорость] Мысль движется со скоростью 400 км/ч",
    };
